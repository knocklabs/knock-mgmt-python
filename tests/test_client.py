...
class TestKnockMgmt:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "knock_mapi/_legacy_response.py",
                        "knock_mapi/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "knock_mapi/_compat.py",
    ...
    def test_client_timeout_option(self) -> None:
        client = KnockMgmt(
            base_url=base_url, service_token=service_token, _strict_response_validation=True, timeout=httpx.Timeout(0)
        )
    ...
    def test_validate_headers(self) -> None:
        ...
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
        assert request.headers.get("Authorization") == f"Bearer {service_token}"

        with pytest.raises(KnockMgmtError):
            with update_env(**{"KNOCK_SERVICE_TOKEN": Omit()}):
                client2 = KnockMgmt(base_url=base_url, service_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_hardcoded_query_params_in_url(self, client: KnockMgmt) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: KnockMgmt) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload_with_body_is_deprecated(self, respx_mock: MockRouter, client: KnockMgmt) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    def test_base_url_trailing_slash(self, client: KnockMgmt) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: KnockMgmt) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: KnockMgmt) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = KnockMgmt(base_url=base_url, service_token=service_token, _strict_response_validation=True)
    ...
    def test_omit_retry_count_header(
        self, client: KnockMgmt, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncKnockMgmt:
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncKnockMgmt) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload(self, respx_mock: MockRouter, async_client: AsyncKnockMgmt) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncKnockMgmt(base_url=base_url, service_token=service_token, _strict_response_validation=True)
