...
class TestBranches:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_create_with_all_params(self, client: KnockMgmt) -> None:
        branch = client.branches.create(
            branch_slug="feature-branch",
    ...
    def test_streaming_response_list(self, client: KnockMgmt) -> None:
        with client.branches.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_delete_with_all_params(self, client: KnockMgmt) -> None:
        branch = client.branches.delete(
            branch_slug="feature-branch",
            environment="development",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_rebase_with_all_params(self, client: KnockMgmt) -> None:
        branch = client.branches.rebase(
            branch_slug="feature-branch",
            environment="development",
        )
...
class TestAsyncBranches:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_create_with_all_params(self, async_client: AsyncKnockMgmt) -> None:
        branch = await async_client.branches.create(
            branch_slug="feature-branch",
            environment="development",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncKnockMgmt) -> None:
        async with async_client.branches.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_delete_with_all_params(self, async_client: AsyncKnockMgmt) -> None:
        branch = await async_client.branches.delete(
            branch_slug="feature-branch",
            environment="development",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_rebase_with_all_params(self, async_client: AsyncKnockMgmt) -> None:
        branch = await async_client.branches.rebase(
            branch_slug="feature-branch",
            environment="development",
        )
