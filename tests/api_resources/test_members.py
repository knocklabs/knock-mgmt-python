...
from knock_mapi.types import Member
...
class TestMembers:
    ...
    def test_method_list(self, client: KnockMgmt) -> None:
        ...
        assert_matches_type(SyncEntriesCursor[Member], member, path=["response"])
...
class TestAsyncMembers:
    ...
    async def test_method_list(self, async_client: AsyncKnockMgmt) -> None:
        ...
        assert_matches_type(AsyncEntriesCursor[Member], member, path=["response"])
